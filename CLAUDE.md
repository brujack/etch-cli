...
Unit tests in `lib/src/`, integration tests in `app/tests/` (assert_cmd + insta snapshots). Coverage ~86% macOS / ~82.64% Linux CI — gap is macOS-only tests gated with `#[cfg(target_os = "macos")]`.
