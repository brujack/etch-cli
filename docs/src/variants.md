...
A command example of a variant is a variant based on the operating system. Suppose you have an action that is going to differ slightly between a linux and macOS system. The following is an example of that.
