...
This is the most basic, but yet powerful action as it can be used to run anything needed that is not directly supported in etch by an action. An alias exists, allowing you to abbreviate `command` as `cmd`.
