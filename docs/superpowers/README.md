...
| Feature                                    | Notes                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| os.arch context field                      | Expose `std::env::consts::ARCH` as `os.arch` in `OSContextProvider`. Enables `where:` guards like `'os.arch == "aarch64"'` instead of requiring manual `has_apple_silicon` variables. One-liner addition to `lib/src/contexts/os.rs` alongside `os.family` and `os.name`.                                                                                                      |
