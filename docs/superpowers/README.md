...
| Feature                                    | Notes                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| subcommand help discoverability            | `etch --help` lists subcommands but not their flags; users must know to run `etch apply --help` to find `--dry-run`, `etch update --help`, etc. Options: (1) add a `--help-all` / `--help-verbose` flag that prints all subcommand help in one shot, or (2) append each subcommand's flag summary inline under its entry in the top-level help output. |
